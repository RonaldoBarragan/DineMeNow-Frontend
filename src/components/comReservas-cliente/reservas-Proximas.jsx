                                ...
                                <div className="modal-cuadro">
                                    <div className="columna-pricipal">
                                        <div className="info-desc-modal">
                                            <CiCalendar size={15} /> 14 de
                                            octubre de 2025
                                        </div>
                                        <div className="info-desc-modal">
                                            <RxPeople size={15} /> 4 personas
                                        </div>
                                    </div>
                                    {/* LADO DERECHO */}
                                    <div className="columna-pricipal">
                                        <div className="info-desc-modal">
                                            <IoMdTime size={15} /> 19:00
                                        </div>
                                        <div className="info-desc-modal">
                                            <IoLocationOutline size={15} /> Mesa
                                            5
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="info-platillos">
                                ...
                                <div className="info">
                                    ...
                                    <div className="platillo-total">
                                        ...
                                        <span className="valor-total-platos">
                                            $61.000
                                        </span>
                                    </div>
                                </div>
                        ...
                        <Modal.Body>
                            ...
                            <div className="info">
                                ...
                                <div className="modal-cuadro">
                                    <div className="columna-pricipal">
                                        <div className="info-desc-modal">
                                            <CiCalendar size={15} /> 19 de
                                            octubre de 2025
                                        </div>
                                        <div className="info-desc-modal">
                                            <RxPeople size={15} /> 2 personas
                                        </div>
                                    </div>
                                    {/* LADO DERECHO */}
                                    <div className="columna-pricipal">
                                        <div className="info-desc-modal">
                                            <IoMdTime size={15} /> 20:30
                                        </div>
                                        <div className="info-desc-modal">
                                            <IoLocationOutline size={15} /> Mesa
                                            8
