        ...
        <Card>
            <Card.Body>
                ...
                <Form>
                    ...
                    <Button variant="outline-secondary" className="mt-2">Seleccionar Archivos</Button>
                    ...
                    <Button className="px-4" style={{ background: "linear-gradient(to right, #ff7b47, #ff3b1f)", border: "none"}}>Enviar Solicitud</Button>
                    </div>
                </Form>
            </Card.Body>
        </Card>
